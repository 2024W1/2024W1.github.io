...
- packages.bib
description: |
  Es erfolgt keine Trennung in VWL und BWL.
biblio-style: apalike
csl: "chicago-fullnote-bibliography.csl"
subtitle: Es erfolgt keine Trennung in VWL und BWL.
---

# Wirschaftswissenschaft für 2024-25W1 {#chapter-1}
...
5. Die BWL
  - Geschichte
  - Gliederung der ABWL, SBWL
  - Analysegegenstände ausgewählter funktionaler SBWL
    - - BCG-Matrix
    - - Harris-Andler-Formel
    - - das Reisender-Handelsvertreter-Problem
    - - Finanzplan bei einer Unternehmensgründung
    - - Vergleich lineare-geometrische Abschreibung
6. Arbeitsteilung
...
# Der Gegenstand der Wirtschaft {#chapter-2}

## Bedürfnisse {#chapter-2.1}
...
### Gegenständlichkeit {#chapter-2.4.2}
...
Da auch hier Übergänge fließend sind, werden im Rechnungswesen zwei Vereinfachungen vorgenommen. Als Verbrauchsgüter gelten über die obere Definition hinaus alle Güter, die
